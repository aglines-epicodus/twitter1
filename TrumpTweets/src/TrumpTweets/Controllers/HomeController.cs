...
namespace TrumpTweets.Controllers
{
    public class HomeController : Controller
    {
        ...
        public string WordCounts()
        {
            ...
            //List<string> StopList = new List<string> { "rt", "http", "https", "https:", "co", "com", "in", "at", "will", "to", "the", "a", "an", "and", "of", "for", "on", "it", "was", "is", "be", "have", "are", "that", "as", "was", "were", "by", "out", "if", "but", "or", "with"};
            // another list includes pronouns
            List<string> StopList = new List<string> { "me", "i", "my", "he", "him", "his", "she", "her", "hers", "you", "u", "your", "yours", "we", "our", "ours", "they", "their", "theirs", "rt", "http", "https", "https:", "co", "com", "in", "at", "will", "to", "the", "a", "an", "and", "of", "for", "on", "it", "was", "is", "be", "have", "are", "that", "as", "was", "were", "by", "out", "if", "but", "or", "with" };
            ...
            {
                // create a dict of items and their counts for wordcloud
                // use a multiplier to ensure all counts show up
